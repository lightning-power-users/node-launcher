...
from node_launcher.node_set.tor.tor_configuration_keys import keys_info as tor_keys_info
...
class TorConfiguration(Configuration):
    ...
    def __init__(self):
        ...
        super().__init__(name='tor', path=configuration_file_path, assign_op=' ', keys_info=tor_keys_info)
