...
@patch(
    'node_launcher.gui.network_buttons.zap_layout.get_deprecated_lndconnect_url')
@patch('node_launcher.gui.network_buttons.zap_layout.get_qrcode_img')
@patch('node_launcher.gui.network_buttons.zap_layout.webbrowser')
@patch('node_launcher.gui.network_buttons.zap_layout.QPixmap')
@patch('node_launcher.gui.network_buttons.zap_layout.QLabel')
