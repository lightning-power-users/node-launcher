...
class TestGuiUnitTests(object):
    ...
    def test_testnet_grpc_url_copy_button(self, qtbot: QTest,
                                          launch_widget: LaunchWidget):
        qtbot.mouseClick(launch_widget.testnet_group_box.grpc_url_copy_button,
                         Qt.LeftButton)
        rest_url = launch_widget.node_launcher.command_generator.testnet_grpc_url()
        assert QClipboard().text() == rest_url
    ...
    def test_unlock_wallet_button(self, qtbot: QTest, launch_widget: LaunchWidget):
        qtbot.mouseClick(launch_widget.testnet_group_box.unlock_wallet_button,
                         Qt.LeftButton)
        assert launch_widget.testnet_group_box.lnd_client.called_once()
